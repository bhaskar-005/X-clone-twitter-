          ...
          <div className="grid grid-cols-12 gap-3">
            ...
            <div className="col-span-11">
              ...
              <div className="relative">
                ...
                {vidPrev && (
                  <>
                  <video src={vidPrev} autoPlay muted controls controlsList="nodownload"></video>
                  <div
              ...
              <div className="mt-3 flex justify-between items-center ">
                ...
                <BiImageAlt onClick={handleSelectImage} className="text-2xl text-sky-500" />
                <MdOutlineSlowMotionVideo onClick={handleSelectVideo} className="text-2xl text-sky-500" />
                <MdOutlineGifBox onClick={handleSelectImage} className="text-2xl text-sky-500" />
                </div>
                <button
                  onClick={() => handleCreateTweet()}
                  className={` ${
                    content && imagePrev && video
                      ? "opacity-100 cursor-pointer"
                      : "opacity-60 cursor-default"
                  } bg-[#1d9bf0] font-semibold text-sm py-2 px-4 rounded-full`}
                >
                  Tweet
                </button>
              </div>
